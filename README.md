...
Troubleshooting checklist: system requirements all met / DirectXTex library built / paths in build.bat and polyphorm.build point to existing valid folders / there's enough video memory available (if not, decrease 'Grid Resolution' in the config.polyp file.
...
- [Disentangling the Cosmic Web Towards FRB 190608](https://arxiv.org/abs/2005.13157v1) (ArXiv, May 2020; under submission to Astrophysical Journal Letters)<br/>
